...
\begin{frame}[fragile]%---------------------------------------------------------
\frametitle{On the Integration of Residuation and Narrowing}

\blocktitle{Until now, residuation and narrowing are separated}
\begin{itemize}
\item rigid \code{case}-expressions, \code{ensureNotFree}: residuation
\item pattern matching: narrowing
\end{itemize}

\blocktitle{Possible meaningful amalgamations}
\begin{itemize}
\item Proceed a narrowing step whenever residuation would finally suspend
      $\leadsto$ implications?
\item While narrowing is complete, there are examples where residuation
      produces a finite search space and narrowing does not. Can they
      be combined?
\end{itemize}
...
\begin{frame}[fragile]%---------------------------------------------------------
\frametitle{Residuation-Guarded Narrowing}
