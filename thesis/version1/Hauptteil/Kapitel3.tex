...
\\
Die Interface-Funktion \lstinline|solveWith| wird mit Hilfe der in Kapitel 4.2.2 vorgestellten Funktion \lstinline|solveWithMCP| implementiert. Deren Typsignatur und Implementierung ist nur in Hinblick auf die oben angegebenen Wrapper-Typen (also z.B. das Ein- und Auspacken der ursprünglich verwendeten Werte) anzupassen (siehe Anhang \ref{anhangC}).
\\
