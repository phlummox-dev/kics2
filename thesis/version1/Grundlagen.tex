...
\begin{lstlisting}[language=Haskell,caption=MCP-\lstinline|FDSolver| Typklasse (Ausschnitt)]
...
\begin{lstlisting}[language=Haskell,caption=MCP-FDSolver Typklasse (Ausschnitt)]
newtype FDSolver s => 
