...
\end{lstlisting}
Als erstes gibt man etwaige Curry-Gleichheits-Constraints für die Constraint-Variablen an, dann legt man ein Wertebereich für die Constraint-Variablen fest, danach folgen beliebige FD-Constraints über den eingeführten Constraint-Variablen und schließlich initiiert man deren Labeling durch Angabe eines "'Labeling-Constraints"'.
\item Die Curry-Gleichheits-Constraints sind optional und können gegebenenfalls auch an anderer Stelle spezifiziert werden. Sie zuerst anzugeben kann jedoch den Lösungsvorgang beschleunigen, da diese Constraints während der Auswertung dann KiCS2-intern nicht verschoben werden müssen.
